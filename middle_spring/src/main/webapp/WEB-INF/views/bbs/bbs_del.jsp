...
<body>
	<div id="bsDel_wrap">
		...
		<form method="post" action="bbs_del_ok.do?bbs_no=${b.bbs_no}" onsubmit="return del_check();">
		<%-- bbs_no는 get방식으로 전달되고, page와 del_pwd는 post방식으로 전달된다. --%>
			...
			<div id="bsDel_menu">
				<input type="submit" value="삭제" /> <input type="reset" value="취소"
					onclick="$('#del_pwd').focus();" /> <input type="button" value="목록" onclick="location='admin_bbs_list.do?page=${page}';">
			</div>
		</form>
	</div>
</body>
