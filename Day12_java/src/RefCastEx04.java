...
class Child04 extends Mother04{
	void ch04() {
		System.out.println("첫번째 자손클래스 메서드 ch04()");
	}
}// 첫번째 자손클래스
...
public class RefCastEx04 {
	...
	public static void main(String[] args) {
		...
		//Child04 ch01 = (Child04)m04;// 명시적인 다운캐스팅을 함 -> 하지만 사전에 업캐스팅을 하지 않아서 
		                            // 컴파일된 클래스를 실행시 캐스팅 연산 예외 오류가 발생
		
		System.out.println("\n ===============================>");
		
		//Mother04 m05 = new Child04();// Child04 첫번째 자손을 사전에 업캐스팅을 함
		//Child05 child05 = (Child05)m05;// 두번째 자손인 Child05가 사전에 업캐스팅을 하지 않아서
		                               // 컴파일된 클래스를 실행시 캐스팅 연산 예외 오류를 발생시킴
		
		Object obj = new Child05(); // 두번째 자손인 Child05를 사전에 업캐스팅을 함
		Mother04 mother04 = (Mother04)obj;// 명시적인 다운캐스팅
		mother04.m04();
